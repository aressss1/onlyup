...
const AboutSection = () => {
    ...
    return (
        ...
        >
            ...
            <div className="flex lg:text-5xl lg:leading-[1.2] text-3xl lg:w-[68rem] md:w-[39rem]  text-black  " >
            ...
            <div className="lg:text-2xl text-lg lg:w-[67rem] md:w-[29rem] opacity-70  " >
